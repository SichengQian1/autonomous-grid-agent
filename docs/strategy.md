...
The versioned sections below preserve historical decisions. Current v0.19 behavior
...
worker budgets a pre-night route to its defensive position or rear refuge.
